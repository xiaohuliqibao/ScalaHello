...
object Qibao_RDD_LeftOuterJoin {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val lineList: RDD[(String, Int)] = sc.makeRDD(List(("a",1),("b",2),("b",3),("a",4),("a",5),("a",6)),3)
    val lineList2: RDD[(String, Int)] = sc.makeRDD(List(("a",1),("a",2),("b",3),("b",4),("b",5),("a",6)),2)

    val joinRDD: RDD[(String, (Int, Int))] = lineList.join(lineList2)
